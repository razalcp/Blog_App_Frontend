...
import { getBlogById, updateBlog, reset } from '../store/blogSlice';
...
const EditBlog = () => {
  ...
  const { id } = useParams();
  const { currentBlog, isLoading, isError, message, isSuccess } = useSelector((state) => state.blogs);
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-3xl font-bold text-secondary-900">Edit Blog Post</h1>
        </div>
